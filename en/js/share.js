...
export const CANONICAL_URL = 'https://games.userguiding.com/generative-ui-checkup/en/';
...
export const CARD_FILENAME = 'generative-ui-checkup-my-result.png';
...
export function buildCardModel(result) {
  ...
  text('nextLabel', CARD_COPY.nextLabelSource.toLocaleUpperCase('en-US'), {
