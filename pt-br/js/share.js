...
export const CANONICAL_URL = 'https://games.userguiding.com/generative-ui-checkup/pt-br/';
...
export const CARD_FILENAME = 'generative-ui-checkup-meu-resultado.png';
...
export function buildCardModel(result) {
  ...
  text('nextLabel', CARD_COPY.nextLabelSource.toLocaleUpperCase('pt-BR'), {
